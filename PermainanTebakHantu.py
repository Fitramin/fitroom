    ...
    def mulai(self):
        ...
        while True:
            ...
            if pilihan_main == "tidak":
                ...
                hantumerah = "👹"
                hantuputih = "👻"
                a = [hantumerah] * 10  # 10 hantu merah
                skor = 100
                percobaan = 0
                print(f"🥰 Selamat datang, kak {nama_pemain}! 🥰\n")
                print(" ".join(a))
                print()
                b = random.randint(0, 9)  # Posisi hantu putih
                a[b] = hantuputih  # Ganti satu dengan hantu putih
                ...
                while percobaan < 10:
                    ...
                    if tebakan.isdigit():
                        tebakan = int(tebakan) - 1  # Ubah ke indeks 0-9
                ...
                self.pemain_scores.append((nama_pemain, skor))  # Simpan skor setelah game selesai
        
        input("Game tebak hantu sudah berakhir tekan enter untuk keluar")

# Menjalankan permainan jika file ini dieksekusi langsung
